...
This repository an efficient implementation of the MixUp procedure [mixup: Beyond Empirical Risk Minimization](https://arxiv.org/abs/1710.09412). The code is written on top of [fb.resnet.torch](https://github.com/facebook/fb.resnet.torch), [shake-shake](https://github.com/xgastaldi/shake-shake) and uses also the augmentation procedure [CutOut](https://github.com/uoguelph-mlrg/Cutout) before the MixUp.
